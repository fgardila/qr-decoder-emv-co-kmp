...
La publicación en **Maven Central** está en progreso. Mientras tanto, construye los artefactos desde el código fuente:

```bash
./gradlew :emvdecoder:assemble                               # AAR Android → emvdecoder/build/outputs/aar/
